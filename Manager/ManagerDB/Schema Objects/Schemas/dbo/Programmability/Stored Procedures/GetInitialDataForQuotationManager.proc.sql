...
BEGIN
	...
	SELECT Id, Code, MappingCode, DecimalPlace, Inverted, InactiveTime, UseWeightedPrice, Multiplier, IsDerivative, IsSwitchUseAgio, AgioSeconds, LeastTicks FROM dbo.Instrument
