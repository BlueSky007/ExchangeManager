...
namespace ManagerService.DataAccess
{
    internal static class LogHelper
    {
        ...
        internal static void GetBaseLogEntity(this LogEntity entity, SqlDataReader dr)
        {
    ...
    public class LogDataAccess
    {
        ...
        private static void GetLogEntity(LogOrder entity, SqlDataReader dr)
        {
            ...
            entity.OrderRelation = dr.GetItemValue<string>("OrderRelation", string.Empty);
        ...
        private static void GetLogEntity(LogPrice entity, SqlDataReader dr)
        {
            ...
            entity.InstrumentCode = (string)dr["InstrumentCode"];
            entity.OperationType = dr["OperationType"].ConvertToEnumValue<PriceOperationType>();
            if (dr["OutOfRangeType"] != DBNull.Value){entity.OutOfRangeType = (OutOfRangeType)(byte)dr["OutOfRangeType"]; }

            entity.Bid = (string)dr["Bid"];
            entity.Ask = (string)dr["Ask"];
            entity.Diff = dr.GetItemValue<string>("Diff", null);
        }
