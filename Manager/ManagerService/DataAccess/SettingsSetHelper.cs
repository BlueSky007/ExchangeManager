...
namespace ManagerService.DataAccess
{
    ...
    public class AccountReportDataHelper
    {
        ...
        public static void ConvertReportEntity(List<AccountStatusOrder> accountOpenPostions, SqlDataReader dr)
        {
            ...
            entity.MktPrice = dr.GetItemValue<string>("MktPrice", string.Empty);
        ...
        public static void ConvertReportEntity(InstrumentForFloatingPLCalc entity, SqlDataReader dr)
        {
            entity.InstrumentId = (Guid)dr["InstrumentID"];
            entity.InstrumentCode = (string)dr["Code"];
            entity.Bid = (string)dr["Bid"];
            entity.Ask = (string)dr["Ask"];
            entity.SpreadPoint = (int)dr["SpreadPoints"];
        }
    }
}
