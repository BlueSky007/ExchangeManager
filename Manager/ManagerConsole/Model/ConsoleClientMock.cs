...
namespace ManagerConsole.Model
{
    public class ConsoleClientMock
    {
        ...
        //            new Module{ Type= ModuleType.OrderTask, Category= ModuleCategoryType.Dealing, ModuleDescription="单子处理" },
        //            new Module{ Type= ModuleType.LMTOrderTask, Category= ModuleCategoryType.Dealing, ModuleDescription="限价单批量单处理" },
